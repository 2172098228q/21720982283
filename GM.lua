...
local Window = OrionLib:MakeWindow({Name = "雪冬", HidePremium = false, SaveConfig = true,IntroText = "雪冬", ConfigFolder = "雪冬"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "雪冬"; Text ="雪冬"; Duration = 4; })
